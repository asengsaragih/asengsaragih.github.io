...
<head>
    ...
    <script src="assets/js/sessionIndex.js"></script>
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="android.php">
                                <i class="fa fa-mobile"></i>Android</a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fa fa-cloud"></i>IOT</a>
                        </li>
                        <li>
                            <a href="general-setting.php">
                                <i class="fa fa-cog"></i>General Setting</a>
                        </li>
                    </ul>
                </div>
            </nav>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="general-setting.php">
                                <i class="fa fa-cog"></i>Genaral Setting</a>
                        </li>
                    </ul>
                </nav>
            </div>
